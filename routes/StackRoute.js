...
const StackRoute = () => {
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen options={{ headerShown: false }} name="SelectUser" component={SelectUser} />
        ...
        <Stack.Screen options={{ headerShown: false }} name="DoctorDashboard" component={DoctorTab} />
