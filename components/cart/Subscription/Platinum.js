    ...
    return (
        <View style={art.box}>
            ...
            <View style={{
                ...
                <Text style={{fontSize:20,fontWeight:'bold'}}>PetDocto Platinum </Text>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={{ fontWeight: 'bold', fontSize: 10 }}>$ ২৬০ / মাস</Text>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <MaterialCommunityIcons name="checkbox-marked-circle-outline" size={24} color="black" />
                    <Text style={{ fontWeight: '600', fontSize: 12, textAlign: 'center' }}>একটি ফ্রী কন্সাল্টেন্ট পাবেন</Text>
                </View>
